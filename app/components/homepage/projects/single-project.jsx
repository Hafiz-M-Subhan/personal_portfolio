...
const SingleProject = ({ project }) => {
  ...
  return (
    <div className='group w-full h-fit flex flex-col items-center justify-center relative cursor-text overflow-hidden px-3 md:px-8 py-[1.4rem] bg-[linear-gradient(90deg,#281e57_0%,#201435_100%)] shadow-2xl rounded-lg border border-[#1a1443] transition-all duration-300 hover:shadow-2xl hover:shadow-purple-900/50'
    >
      <div className="absolute left-0 top-0 flex justify-center opacity-40 pointer-events-none">
        <svg width="1170" height="403" viewBox="0 0 1170 403" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <div className='flex flex-col items-center justify-between w-full h-full relative z-10'>
        ...
        <div className="flex items-center justify-between w-full gap-4">
          <Link
            ...
            className="flex justify-center items-center w-10 h-10 rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] transition-all duration-300 hover:bg-[#231d4b] hover:text-violet-600 hover:border-[#0F0C41] hover:scale-110 decoration-clone cursor-pointer no-underline delay-[0.3s] focus:outline-none focus:ring-2 focus:ring-violet-600"
